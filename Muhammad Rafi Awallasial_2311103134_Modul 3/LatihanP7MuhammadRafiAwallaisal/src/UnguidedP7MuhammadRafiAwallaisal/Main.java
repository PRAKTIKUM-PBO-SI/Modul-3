...
public class Main {
    public static void main(String[] args) {
        ...
        Mahasiswa mhs = new Mahasiswa("Muhammad Rafi Awallaisal", "123", "2311103134", "Sistem Informasi");
        ...
        mhs.showInfo(); // Menampilkan informasi Mahasiswa
        dosen.showInfo(); // Menampilkan informasi Dosen

        // Menampilkan daftar KRS mahasiswa
        mhs.showKRS(); // Menampilkan daftar mata kuliah yang diambil
