...
public class Main {
    public static void main(String[] args) {
        ...
        Mahasiswa mhs = new Mahasiswa("Najwa", "123", "2311103108", "Sistem Informasi");
        ...
        MataKuliah mk3 = new MataKuliah("SI103", "Algoritma", 4);
        ...
        // Menampilkan KRS dan Total SKS
        mhs.showKRS();
        System.out.println("\nTotal SKS yang diambil: " + mhs.hitungTotalSKS());
    }
}